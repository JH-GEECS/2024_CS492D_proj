accelerate launch train_controlnet.py \
  ...
  --output_dir=runs/dilightnet-openillum-2-1-2-base-v2.2 \
  ...
  # --controlnet_model_name_or_path="runs/dilightnet-openillum-2-1-2-base-v2.1/checkpoint-10000/controlnet"
